...
| `npm run test:ui` | Pass — 16 Chromium scenarios covering semantic controls, state transitions, computed styles, Windows type/control geometry, English/Japanese clipping and unintended wrapping, and minimum-window overflow |
