...
| `npm run test:ui` | Pass — 17 Chromium scenarios covering semantic controls, immediate settings and shortcut state, computed styles, Windows type/control geometry, every English/Japanese settings category without clipping or unintended wrapping, and minimum-window overflow |
