...
Source packaging image: $($Manifest.correspondingSource.packagingImage)
...
Assert-ExactProperties $manifest.correspondingSource @('archiveName', 'archiveSha256', 'assetTag', 'packagingImage', 'buildRepository', 'buildCommit', 'ffmpegRepository', 'ffmpegCommit', 'officialReleaseBaseUrl') 'correspondingSource'
...
if ($manifest.correspondingSource.packagingImage -cnotmatch '^ghcr\.io/[a-z0-9._/-]+@sha256:[0-9a-f]{64}$') {
